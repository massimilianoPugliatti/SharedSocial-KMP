    ...
    Box(
        ...
        if (mode == CameraMode.VIDEO) {
            Surface(
                ...
                Text(
                    text = formatElapsed(elapsedRecordingSeconds),
        ...
        Row(
            ...
            IconButton(
                onClick = { onEvent(CameraEvent.OnPickMediaClick) },
            ...
            if (mode == CameraMode.PHOTO) {
                IconButton(
                    onClick = { onEvent(CameraEvent.OnTakePhotoClick) },
                    enabled = !isLoading
                ) {
                    Icon(
            ...
            IconButton(
                onClick = { onEvent(CameraEvent.OnSwitchCameraClick) },
                enabled = !isLoading && !isRecording
            ) {
                Icon(
