...
/**
 * Implementazione Android di [SecureStorage] basata su Google Tink e Jetpack DataStore.
...
class AndroidSecureStorage(
    ...
    override suspend fun getString(key: String): String? = withContext(dispatchers.io) {
        val prefKey = stringPreferencesKey(key)
        val base64Value = dataStore.data.map { it[prefKey] }.firstOrNull() ?: return@withContext null
